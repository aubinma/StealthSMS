...
class Phones():
        ...
        if copy == "y":
            ...
            if check == "n":
                ...
                if check2 == 'y':
                    ...
                    print(
                        f"{GREEN}[INFO]{WHITE} Please Follow us on {BLUE}Twitter{WHITE} : \n")
                    sleep(5)
                elif check2 == 'n':
                    print(
            ...
            if check == "y":
                print(
                    f"\n{BOLD}{GREEN}[INFO]{WHITE} Thank You, Happy to help you\n{GREEN}[INFO]{WHITE} Please Follow us on {BLUE}Twitter{WHITE}:{YELLOW} https://twitter.com{WHITE}\n")
                sleep(3)
    ...
    def myTempSms(self, country, id):
        ...
        if copy == "y":
            ...
            if check == "n":
                ...
                if check2 == 'y':
                    print(
                        f"\n{GREEN}[INFO]{WHITE} Thank You, Happy to help you\n\n")
                    print(
                        f"{GREEN}[INFO]{WHITE} Please Follow us on {BLUE}Twitter{WHITE} : https://twitter.com/REED\n")
                    sleep(5)
                elif check2 == 'n':
                    print(
                        f"\n{RED}[ERR]{WHITE} Please run {YELLOW}SMSme.py{WHITE} again and Choose another number!\n")
            ...
            if check == "y":
                print(
                    f"\n{BOLD}{GREEN}[INFO]{WHITE} Thank You, Happy to help you\n{GREEN}[INFO]{WHITE} Please Follow us on {BLUE}Twitter{WHITE}:{YELLOW} https://twitter.com/asserREED{WHITE}\n")
                sleep(3)
        elif copy == "n":
            print(
                f"\n{RED}[ERR]{WHITE} Please use the number on the website Then run {YELLOW}SMSme.py{WHITE}\n")
    ...
    def myTempSmsSecond(self, country, id):
        ...
        if copy == "y":
            ...
            if check == "y":
                print(
                    f"\n{BOLD}{GREEN}[INFO]{WHITE} Thank You, Happy to help you\n{GREEN}[INFO]{WHITE} Please Follow us on {BLUE}Twitter{WHITE}:{YELLOW} https://twitter.com/REED{WHITE}\n")
                sleep(3)
        elif copy == "n":
            print(
                f"\n{RED}[ERR]{WHITE} Please use the number on the website Then run {YELLOW}SMSme.py{WHITE}\n")
